...
{
    public partial class StockTakeRecordingSlip
    {
        [Parameter] public List<StockTakeRecordingSlipInfos> _dataTransfer { get; set; }
        ...
        async Task RefreshDataAsync()
        {
            try
            {
                _dataTransfer = await _localStorage.GetItemAsync<List<StockTakeRecordingSlipInfos>>("StockTakeRecordingSlipInfosTransfer");
